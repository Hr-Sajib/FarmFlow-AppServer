...
import { insertSensorDataPoint, getAllSensorData } from './sensorData.controller';
...
sensorRoutes.post('/', validateRequest(sensorDataValidations.SensorDataValidationSchema), insertSensorDataPoint);
